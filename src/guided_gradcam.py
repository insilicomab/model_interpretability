...
from utils import DataTransform, ImageLoader, load_model_pth
...
def main(cfg: DictConfig):
    ...
    model = load_model_pth(
        cfg.model_name, num_classes=cfg.num_classes, model_dir=cfg.model_dir
    )
    model.eval()
    ...
    guided_gc = captum.attr.GuidedGradCam(
        ...
        model.stages[3]
        .blocks[2]
        .drop_path,  # <=== only layer needs to be defined here !!!
